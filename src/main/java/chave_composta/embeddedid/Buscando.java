...
public class Buscando {
	...
	public static void main(String[] args) {
		...
		String jpql = "select m from Matricula m where m.id.idAluno = :codAluno AND m.id.idTurma = :codTurma";
		...
		jpql = "select m.dataMatricula from Matricula m where m.id.idAluno = ?1 AND m.id.idTurma = ?2";
